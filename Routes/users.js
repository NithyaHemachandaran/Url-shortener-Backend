...
router.post("/signup", async (req, res) => {
    try {
      ...
      //generate token to activate account 
        ...
        const link = `${process.env.BASE_URL}/activate/${hashedUser._id}?activateToken=${token}`;
  ...
  router.post("/activation", async (req, res) => {
    try {
      ...
      //generate token to activate account 
        ...
        const link = `${process.env.BASE_URL}/activate/${user._id}?activateToken=${token}`;
...
router.post("/forgot-password", async(req, res) => {
    try {
        ...
        const link = `${process.env.BASE_URL}/authorize/?id=${user._id}&token=${token}`;
